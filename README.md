...
Бот для Telegram: принимает фото файлом без сжатия, предлагает канал и сторону логотипа, возвращает готовую картинку 4:5 как файл.
...
- Больше: кнопка уже есть, файлы нужно будет добавить позже как `assets/logos/bolshe_left.png` и `assets/logos/bolshe_right.png`

Все текущие PNG-оверлеи лежат в `assets/logos/` и имеют размер `1080x1350`.
